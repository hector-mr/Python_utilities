...
for l in range(lenfi):
    ...
    t[l+1] = Column(Spectra_resp[l], name = expl_names[l][:-5], unit = 'ph+1s-1keV-1') 
...
Table_end.write('spectra_resp_Suzaku_%s_%s.fits' % (shock, remnant), format = 'fits', overwrite = 'True') 