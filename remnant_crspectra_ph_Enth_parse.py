...
for l in range(lenfi):
	...
	u[l+1] = Column(1.E14 / En_step * Spectra_em_sumTe[l], name = expl_names[l][:-5], unit='ct+1cm-2s-1keV-1')
...
shock = path_files.split(os.sep)[-2]
remnant = path_files.split(os.sep)[-3][4:]

Table_end_ph.write('spectra_ph_Enth_%s_%s.fits' % (shock, remnant), format = 'fits', overwrite = 'True') 